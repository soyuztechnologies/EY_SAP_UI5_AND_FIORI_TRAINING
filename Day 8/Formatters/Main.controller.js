sap.ui.define(
    ...
    function(Controller, model, lifeSaver){
        //Inheritence of standard sap ui5 class to
        //define our controller class
        return Controller.extend("mickey.controller.Main",{
            //we can create global (accessible with the controller in ALL method of CURRENT controller)
            x: 10,
            pi: 3.14,
            //a global variable @ CONTROLLER level which is accessible in current view
            formatter: lifeSaver,
            onInit: function() {
            ...
            onSelect: function(oEvent){
                ...
                //this.getView().byId("idTab")
                //using getSource, we will automatically the table object
